...
const TransactionModal = () => {
  ...
  const onSubmit = async () => {
    ...
    // if (!name.trim || !image) {
    //   Alert.alert("transaction", "Please fill in the name field");
    //   return;
    // }
    // console.log("hee");
    ...
    <View className="flex-1 bg-black">
      ...
      >
        ...
        {/* expense category */}
          ...
          <Animatable.View animation="fadeInUp" delay={200} className="">
            <Text className="text-gray-300 mb-2">Transaction Icon</Text>
            <ImageUpload
